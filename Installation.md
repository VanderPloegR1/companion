...
Instructions to install and run Companion on a Raspberry Pi can be found here: [Raspberry Pi](https://github.com/bitfocus/companion/wiki/Companion-on-the-Raspberry-Pi)
